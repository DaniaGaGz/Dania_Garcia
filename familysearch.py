...
def print_death_age(people_dict):
    ...
    for i in people_dict:
        ...
        death = person[DEATH_YEAR_INDEX] - person[BIRTH_YEAR_INDEX]
        print(f"{name}, death at {death} years old")
    print()
...
def print_marriages(marriages_dict, people_dict):
    ...
    for i in marriages_dict:
        ...
        h = wedding[HUSBAND_KEY_INDEX]
        w = wedding[WIFE_KEY_INDEX]
        m_year = wedding[WEDDING_YEAR_INDEX] 

        husband_name = people_dict[h]
        wife_name = people_dict[w]

        husband_age = m_year - husband_name[BIRTH_YEAR_INDEX]
        wife_age = m_year - wife_name[BIRTH_YEAR_INDEX]
        "namey = people_dict[NAME_INDEX]"
        
        print(f"{husband_name[0]} got married at {husband_age} y/o and his wife {wife_name[0]} at {wife_age} y/o in the year {m_year}")
